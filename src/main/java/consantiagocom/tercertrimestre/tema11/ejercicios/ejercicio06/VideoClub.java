    ...
    private void generarAlquileresAleatorios() {
        ...
        for(int i = 0; i < multimedia.size(); i++) {
            ...
            if(Lib.aleatorio(1,10) > 3) {
                ...
                /** Asumimos que los alquileres se devuelven entre 1 y 6 días después de su Alquiler
    ...
    private void generarPeliculasAleatorias(int nPeliculas) {
        ...
        for(int i = 0; i < nPeliculas; i++) {
            Pelicula pelicula = new Pelicula(faker.funnyName().name(),
                    ...
                    Formato.random(),
                    Lib.aleatorio(1990, 2019), //Podrían ser constantes de configuración
                    Lib.aleatorio(90, 130), //Podrían ser constantes de configuración
