...
/**
 * Clase que actúa como Main.
 * Realiza la E/S y validación de datos
 */
public class Ejercicio06 {
    ...
    /**
     * Muestra el menú principal, solicita una opción al usuario y ejecuta la opción elegida
     */
    public Ejercicio06() {
        int opcion;
    ...
    /**
     * Muestra el menú principal de la aplicación y solicita al usuario una opción válida
     * @return La opción (válida) elegida por el usuario
     */
    ...
    /**
     * Muestra el menú de consultas, solicita una opción y ejecuta la opción seleccionada
     */
